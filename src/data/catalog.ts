...
export const products: Product[] = [
  { slug: "aria-silk-tote", name: "The Aria Silk Tote", price: 1250, category: "Tote bag 18*18", color: "", material: "", rating: 5, stock: 18, badge: "New In", image: productImg, gallery: [productImg, productAlt, detailImg], description: "A masterpiece of functional elegance with premium pebbled leather, rose gold hardware, and a silk-lined interior shaped for everyday rituals." },
